        ...
        <div class="right-bar">
            <div data-simplebar class="h-100">
                ...
                <div class="p-4">
                    ...
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input theme-choice" type="checkbox" id="dark-mode-switch" data-bsStyle="{{asset('assets/css/bootstrap-dark.min.css" data-appStyle="backend/assets/css/app-dark.min.css')}}">
